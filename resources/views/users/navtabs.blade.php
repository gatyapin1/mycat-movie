<ul class="nav nav-tabs nav-justified mb-3">
    <li class="nav-item"><a href="{{ route('users.show', ['id' => $user->id]) }}" class="nav-link {{ Request::is('users' . $user->id) ? 'active' : '' }}">私の動画 <span class="badge badge-secondary">{{ $count_my_movies }}</span></a></li>
